...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  const lightColors = {
    ...
    button: "from-orange-500 to-amber-100",
  };
  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        ...
        className={`flex justify-center items-center ${colors.navBg} backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg `}
      >
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              {darkMode ? (
                ...
                <Moon className="w-5 h-5 text-gray-700"></Moon>
              )}
            </motion.button>
            {/* Button */}
            <motion.a
