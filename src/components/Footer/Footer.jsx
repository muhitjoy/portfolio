        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-[#6b7280] dark:text-[#9ca3af]">
              Full-Stack MERN Developer focused on <br />
          ...
          <div className="text-sm space-y-3 text-center md:text-right text-[#6b7280] dark:text-[#9ca3af]">
            <div className="flex items-center justify-center md:justify-end gap-2">
              ...
              <a className="hover:text-orange-500">muhitjoy2004@gmail.com</a>
            </div>

            <div className="flex items-center justify-center md:justify-end gap-2">
              <span className="text-orange-500"></span>
              <a className="hover:text-orange-500 flex gap-2 items-center">
                {" "}
                <BsTelephoneFill
